...
public class SubQuery {
    ...
    public static enum Aggregator {
         ...
         * 聚合方法
         */
        MULT("mult"), P90("p90"), ZIMSUM("zimsum"), MIMMAX("mimmax"), SUM("sum"),
        P50("p50"), NONE("none"), P95("p95"), EP99R7("ep99r7"), P75("p75"), P99("p99"),
        EP99R3("ep99r3"), EP95R7("ep95r7"), MIN("min"), AVG("avg"), EP75R7("ep75r7"),
        DEV("dev"), EP95R3("ep95r3"), EP75R3("ep75r3"), EP50R7("ep50r7"), EP90R7("ep90r7"),
        MIMMIN("mimmin"), P999("p999"), EP50R3("ep50r3"), EP90R3("ep90r3"), EP999R7("ep999r7"),
        LAST("last"), MAX("max"), COUNT("count"), EP999R3("ep999r3"), FIRST("first");
    ...
    public static class Filter {
        ...
        public static enum FilterType {
            ...
            /**
             * 具体说明可以手动调用openTSDB的接口获取
             * get请求ip:port/api/config/filters
             */
            REGEXP("regexp"),
            IWILDCARD("iwildcard"),
